            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              {googleUser ? (
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-50 active:scale-98 text-slate-700 text-xs sm:text-sm font-bold rounded-xl border border-slate-300 shadow-xs hover:shadow transition-all cursor-pointer disabled:opacity-50"
                >
                  {isAuthenticating ? (
